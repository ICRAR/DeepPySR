#!/bin/bash
#SBATCH --job-name=bodyfatwarm
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=32
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bodyfatwarm.log
...
python -u test/bodyfat/test_all_models_bodyfat_warm.py
STATUS=$?
