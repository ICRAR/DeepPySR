#!/bin/bash
#SBATCH --job-name=feynman_I_6_2a_vps75
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/feynman_I_6_2a_vps75.log
...
echo "Starting feynman_I_6_2a_vps75 at $(date)"
python -u test/feynman/test_all_models_feynman.py --eq_name I.6.2a --vps 75
echo "Finished feynman_I_6_2a_vps75 at $(date)"
