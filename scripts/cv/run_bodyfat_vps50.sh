#!/bin/bash
#SBATCH --job-name=bodyfat_vps50
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bodyfat_vps50.log
...
echo "Starting bodyfat_vps50 at $(date)"
python -u test/bodyfat/test_all_models_bodyfat.py --vps 50
echo "Finished bodyfat_vps50 at $(date)"
