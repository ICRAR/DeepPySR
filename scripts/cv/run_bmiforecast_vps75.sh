#!/bin/bash
#SBATCH --job-name=bmiforecast_vps75
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bmiforecast_vps75.log
...
set -e
echo "Starting bmiforecast_vps75 at $(date)"
python -u test/bmiforecast/test_deeppysr_bmiforecast.py --vps 75
echo "Finished bmiforecast_vps75 at $(date)"
