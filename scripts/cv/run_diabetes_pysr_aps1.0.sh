#!/bin/bash
#SBATCH --job-name=diabetes_pysr_aps1.0
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/diabetes_pysr_aps1.0.log
...
echo "Starting diabetes_pysr_aps1.0 at $(date)"
python -u test/diabetes/test_baselines_pysr_diabetes.py --model_group pysr --aps 1.0
echo "Finished diabetes_pysr_aps1.0 at $(date)"
