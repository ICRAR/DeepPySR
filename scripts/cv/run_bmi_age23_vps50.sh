#!/bin/bash
#SBATCH --job-name=bmi_age23_vps50
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bmi_age23_vps50.log
...
echo "Starting bmi_age23_vps50 at $(date)"
python -u test/bmi/test_all_models_bmi.py --setting age_specific --age 23 --vps 50
echo "Finished bmi_age23_vps50 at $(date)"
