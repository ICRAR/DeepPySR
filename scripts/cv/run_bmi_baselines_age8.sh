#!/bin/bash
#SBATCH --job-name=bmi_baselines_age8
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bmi_baselines_age8.log
...
echo "Starting bmi_baselines_age8 at $(date)"
python -u test/bmi/test_baselines_pysr_bmi.py --setting age_specific --age 8
echo "Finished bmi_baselines_age8 at $(date)"
