#!/bin/bash
#SBATCH --job-name=insulin_baselines_age14_homa_ir
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/insulin_baselines_age14_homa_ir.log
...
echo "Starting insulin_baselines_age14_homa_ir at $(date)"
python -u test/insulin/test_baselines_pysr_insulin.py --age 14 --target homa_ir
echo "Finished insulin_baselines_age14_homa_ir at $(date)"
