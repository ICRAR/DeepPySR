#!/bin/bash
#SBATCH --job-name=wine_white_vps25
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/wine_white_vps25.log
...
echo "Starting wine_white_vps25 at $(date)"
python -u test/wineQuality/test_all_models_wine.py --wine_type white --vps 25
echo "Finished wine_white_vps25 at $(date)"
