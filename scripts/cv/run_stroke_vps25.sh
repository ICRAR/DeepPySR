#!/bin/bash
#SBATCH --job-name=stroke_vps25
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/stroke_vps25.log
...
echo "Starting stroke_vps25 at $(date)"
python -u test/stroke/test_all_models_stroke.py --vps 25
echo "Finished stroke_vps25 at $(date)"
