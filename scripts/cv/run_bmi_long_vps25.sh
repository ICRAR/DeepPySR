#!/bin/bash
#SBATCH --job-name=bmi_long_vps25
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bmi_long_vps25.log
...
echo "Starting bmi_long_vps25 at $(date)"
python -u test/bmi/test_all_models_bmi.py --setting longitudinal --vps 25
echo "Finished bmi_long_vps25 at $(date)"
