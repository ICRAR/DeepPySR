#!/bin/bash
#SBATCH --job-name=student_baselines_mat
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/student_baselines_mat.log
...
echo "Starting student_baselines_mat at $(date)"
python -u test/studentPerformance/test_baselines_pysr_student.py --subject mat
echo "Finished student_baselines_mat at $(date)"
