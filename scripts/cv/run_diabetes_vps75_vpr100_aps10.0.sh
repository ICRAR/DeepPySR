#!/bin/bash
#SBATCH --job-name=diabetes_vps75_vpr100_aps10.0
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/diabetes_vps75_vpr100_aps10.0.log
...
echo "Starting diabetes_vps75_vpr100_aps10.0 at $(date)"
python -u test/diabetes/test_all_models_diabetes.py --vps 75 --vpr 100 --aps 10.0
echo "Finished diabetes_vps75_vpr100_aps10.0 at $(date)"
