#!/bin/bash
#SBATCH --job-name=student_mat_vps25
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/student_mat_vps25.log
...
echo "Starting student_mat_vps25 at $(date)"
python -u test/studentPerformance/test_all_models_student.py --subject mat --vps 25
echo "Finished student_mat_vps25 at $(date)"
