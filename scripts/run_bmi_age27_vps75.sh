#!/bin/bash
#SBATCH --job-name=bmi_age27_vps75
#SBATCH --account=pawsey0411
#SBATCH --time=1-00:00:00
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --output=/scratch/pawsey0411/fchen1/DeepPySR/scripts/bmi_age27_vps75.log
...
echo "Starting bmi_age27_vps75 at $(date)"
python -u test/bmi/test_all_models_bmi.py --setting age_specific --age 27 --vps 75
echo "Finished bmi_age27_vps75 at $(date)"
