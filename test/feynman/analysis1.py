            ...
            for model_name in os.listdir(baselines_dir):
                ...
                if model_name.lower() == 'kan':
                    ...
                    if os.path.exists(overall_metrics_sym_file):
                        ...
                        _, _, metrics = get_best_formula_from_raw(model_path, X_df, y_true, prefix='formulas_fold', model_type='kan')
                        r2, rmse, mae = metrics

                    formula, complexity, _ = get_best_formula_from_raw(model_path, X_df, y_true, prefix='formulas_fold', model_type='kan')
