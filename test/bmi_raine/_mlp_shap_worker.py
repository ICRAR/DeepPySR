...
Run in its own subprocess by analysis_bmi.py's
_bmi_mlp_shap_importance_subprocess -- importing model_utils (and
...
def main():
    ...
    import analysis_bmi as ab

    load_fn, _ = ab.VARIANTS[args.variant]
    _, X, y = ab._load_age(load_fn, args.age)
    imp = ab._bmi_mlp_shap_importance(X, y, task='regression',
