        ...
        for model_name in os.listdir(baselines_dir):
            ...
            if model_name.lower() == 'kan':
                ...
                if os.path.exists(overall_metrics_sym_file):
                    ...
                    acc, prec, rec, f1 = df_metrics_sym['accuracy'].iloc[0], df_metrics_sym['precision'].iloc[0], df_metrics_sym['recall'].iloc[0], df_metrics_sym['f1'].iloc[0]
                    auc = df_metrics_sym['auc'].iloc[0] if 'auc' in df_metrics_sym.columns else 0
                else:
