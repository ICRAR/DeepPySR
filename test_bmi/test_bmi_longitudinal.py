...
pysr_kwargs = {
                ...
                "parsimony": 0.005,#0.001,
                # "niterations": 500,
                "populations": 20,#15,
                "population_size": 100,
                "ncycles_per_iteration": 200,
                "adaptive_parsimony_scaling": 100.0,#50.0,
                "variable_prune_start": 40,#50, # new defined
                "variable_prune_ramp": 80,#150, # new defined
                "variable_prune_max": 0.7,#0.6, # new defined
...
def main():
    ...
    for r2w_ in r2w:
        for l_ in l:
            outdir = (f"./results_bmi/agg_deeppysr/par{parsimony}_pop{population}_popsz{pop_size}_"
